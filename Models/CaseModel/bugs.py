...
class Bug(Base):
    ...
    def __init__(self, title: AnyStr, desc: AnyStr, developer: int, pr: int, bug_type: AnyStr, level: AnyStr,
                 versionID: int, caseID: int,
                 status: AnyStr = "OPEN", file: AnyStr = None, mark: AnyStr = None, platformID: int = None,
                 tester: int = None,
                 ):
        self.title = title
        self.desc = desc
