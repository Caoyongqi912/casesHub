...
class CaseController(Resource):
    ...
    def post(self) -> MyResponse:
        ...
        parse.add(name="setup", type=str, required=True)
        parse.add(name="exp", type=str, required=True)
        parse.add(name="level", type=str, choices=["P1", "P2", "P3", "P4"], required=True)
...
api_script.add_resource(CaseController, "/")
